(function () {
  ...
  function enhancePageKicker() {
    ...
    if (kinds.category) {
      // Categories intentionally use the links page's animated logo and text treatment.
  ...
  function closeCompactSearch() {
    ...
    document.body.classList.remove('pro-search-has-query');
    document.body.style.width = '';
    document.body.style.overflow = '';
  ...
  function renderProSearchResults() {
    ...
    document.body.classList.add('pro-search-has-query');
  ...
  function ensureTopNav() {
    ...
    nav.innerHTML = [
      '<a href="/" class="pro-top-nav__item">首页</a>',
      '<button type="button" class="pro-top-nav__item pro-top-nav__search">搜索</button>',
      '<a href="/categories/" class="pro-top-nav__item">分类</a>',
      '<a href="/link/" class="pro-top-nav__item">友链</a>'
    ].join('');
  ...
  function markPageKinds() {
    ...
    // Categories intentionally reuse the links-page logo treatment per design choice.
    document.body.classList.toggle('pro-links-page', kinds.links || kinds.category);
    document.body.classList.toggle('pro-category-page', kinds.category);
  ...
  function getPageKinds() {
    return {
      ...
      category: Boolean(document.querySelector('.category-lists, #category')),
